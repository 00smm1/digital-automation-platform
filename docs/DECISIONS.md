...
### ADR-012 (Sprint 13): First digital fulfillment vertical slice

**Context:** Sprints 11–12 connected orchestration and pipelines separately; Phase 2 requires proving full in-memory fulfillment without external integrations.
